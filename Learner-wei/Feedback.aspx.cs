...
namespace WAPPAssignment
{
    public partial class Feedback : System.Web.UI.Page
    {
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            {
                Label3.Text = "You must be logged in to submit feedback.";
                return;
            }
            ...
            {
                string query = "INSERT INTO Feedback (StudentId, FeedbackMessage, CreatedAt) " +
                               "VALUES (@StudentId, @FeedbackMessage, GETDATE())";
